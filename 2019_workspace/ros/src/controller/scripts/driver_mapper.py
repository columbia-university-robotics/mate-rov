...
class Driver_Mapper(object):

	def __init__(self, publish, create_publisher):
		
		self.name = "driver"							#driver is the same thing as ROV
		self.publish = publish                          #passing the publish function from controller class through this class

		self.mapping_dict = {}

		self.mapping_dict["left_vert"] = create_publisher('controller/rov/left_vert')
		self.mapping_dict["left_hori"] = create_publisher('controller/rov/left_hori')
		self.mapping_dict["right_vert"] = create_publisher('controller/rov/right_vert')
		self.mapping_dict["right_hori"] = create_publisher('controller/rov/right_hori')
		self.mapping_dict["right_topbump"] = create_publisher('controller/rov/right_topbumper')
		self.mapping_dict["right_botbump"] = create_publisher('controller/rov/right_bottombumper')
